...
let cam = new Camera();
cam.projPerspective();
scene = Scene.buildFromCameraName(cam.translate(0, 0, 8), "Solar System 2b");
...
function rotate()
{
    ...
    planetMoon = planetMoon.transform(Matrix.translate(
    ...
    moon = moon.transform(Matrix.translate(
