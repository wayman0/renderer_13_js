...
export default class SphereSubdivided extends Model
{
   ...
   <p>
      ...
      @param {boolean} hole        do not render one of the four triangles of the tetrahedron
   ...
   */
   constructor( n = 4,  hole = false,  sierpinski = false)
   {
      ...
      const v1 = new Vertex(-sqr3inv,  sqr3inv, -sqr3inv);
      const v2 = new Vertex( sqr3inv, -sqr3inv, -sqr3inv);
      const v3 = new Vertex(-sqr3inv, -sqr3inv,  sqr3inv);
      ...
      if (!hole) this.sub(n, v3, v1, v0, sierpinski);
   }
   ...
   */
   sub( n,  v0,  v1,  v2,  sierpinski)
   {
      ...
      else
      {
         ...
         // Normalize the subdivision polets.
         ...
         if (! sierpinski) this.sub(n-1, v3n, v4n, v5n, sierpinski);
      }
   }
}//SphereSubdivided
