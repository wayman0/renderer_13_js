...
import {Model, Vertex, LineSegment, Lines, LineLoop, LineFan} from "../scene/SceneExport.js";
...
export default class Tetrahedron extends Model 
{
   ...
   */
   constructor(m0=1, m1=1, m2=1, m3=1)
   {
      ...
      this.addPrimitive(new Lines(0,1, 2,3), 
                        new LineLoop(0, 2, 1, 3));
