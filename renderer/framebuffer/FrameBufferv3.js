...
export default class FrameBuffer
{
    ...
    /**@type {ArrayBuffer} #pixelBuffer the actual pixel data for this framebuffer */ #pixelBuffer;
...
*/
    ...
    constructor(width, height, color = Color.Black)
    {
        ...
        this.#pixelBuffer = new ArrayBuffer(this.#width * this.#height * 4);
    ...
    */
    ...
    static main()
    {
        ...
        */
        ...
        fb.setPixelFB(10, 10, Color.BLACK);
        fb.setPixelFB(11, 11, Color.black);
        fb.setPixelFB(12, 12, Color.black);
        fb.setPixelFB(13, 13, Color.black);
        fb.setPixelFB(14, 14, Color.black);
        fb.setPixelFB(15, 15, Color.black);
        fb.setPixelFB(16, 16, Color.black);
        fb.setPixelFB(17, 17, Color.black);
        fb.setPixelFB(18, 18, Color.black);
        fb.setPixelFB(19, 19, Color.black);
        fb.setPixelFB(20, 20, Color.black);

        fb.dumpFB2File("Cyanwithblack.ppm");
