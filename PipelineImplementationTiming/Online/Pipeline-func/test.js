...
alert("Airplane Avg: " + (time/360));
console.log("Airplane Avg: " + (time/360));


//alert("Cube2(40, 50, 60) Rotate 1 Degree 360 Degrees")
time = 0; 
scene = new Scene();
...
alert("Cube Avg: " + (time/360));
console.log("Cube Avg: " + (time/360));

//alert("Cow Rotate 1 Degree 360 Degrees")
time = 0; 
scene = new Scene();
...
alert("Cow Avg: " + (time/360));
console.log("Cow Avg: " + (time/360));

//alert("All Four Rotate 1 Degree 360 Degrees")
time = 0; 
scene = new Scene();
