...
import {Position, Matrix, Model, Vertex} from "../../renderer/scene/SceneExport.js";
import { check } from "../../renderer/scene/util/CheckModel.js";
 ...
 * system to the world coordinate system.
 * 
 * @param {Vertex} vert the vertex to be transformed
 * @return {Vertex} a new {@link Vertex} object in the world coordinate system
 */
export function model2worldModel(vert)
{
   return ctm2.timesVertex(vert);
}
...
export function model2worldNestedModel(model, ctm)
{
   ...
   ctm2 = ctm.timesMatrix(model.matrix);
   const mod2 = new Model(model.vertexList.map(model2worldModel),
                          model.primitiveList, 
                          model.colorList, 
                          model.matrix,
                          model.nestedModels, 
