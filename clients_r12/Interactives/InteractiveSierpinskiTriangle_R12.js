...
import {currentModel, display, eyeX, eyeY, eyeZ, handleKeyDown, handleKeyPress, printHelpMessage, scale, 
        scene, setCameraX, setCurrentModel, setDebugWholeScene, setInteractiveModelsAllVis, 
        setNumInteractiveMod, setPrintHelpMessageFunc, setScene, setTransformationsFunc, 
        xRotation, xTranslation, yRotation, yTranslation, zRotation, zTranslation} from "./InteractiveAbstractClient_R12a.js";
...
setScene(Scene.buildFromName("InteractiveSierpinskitriangle_R12"));
setCameraX(1);
...
function newPrintMessage()
{
    ...
    console.log("Use alt + x/X, y/Y, z/Z keys to translate the camera along the x, y, z, axix.");
    console.log("Use alt + u/U, v/V, w/W keys to rotate the camera around the x, y, z axis.");
    console.log("Use alt + s/S keys to zoom the camera in and out.");
