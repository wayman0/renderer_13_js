...
import {currentModel, display, handleKeyDown, handleKeyPress, printHelpMessage, setCurrentModel, 
        setDebugWholeScene, setInteractiveModelsAllVis, setNumInteractiveMod, setScene, scene} from "./InteractiveAbstractClient_R11.js";

const assets = "../../assets/";

setScene(Scene.buildFromName("InteractiveModelsAll_R11"));
