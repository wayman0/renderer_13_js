...
import {currentModel, display, handleKeyDown, handleKeyPress, numberOfInteractiveModels, 
        ...
        xTranslation, yTranslation, zTranslation, xRotation, yRotation, zRotation, scene} from './InteractiveAbstractClient_R12b.js';

const assets = "../../assets/";

setScene(Scene.buildFromName("InteractiveModels_R12b"));
