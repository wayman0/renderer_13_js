...
import {currentModel, display, handleKeyDown, handleKeyPress, printHelpMessage, setCurrentModel, 
        setDebugWholeScene, setInteractiveModelsAllVis, setNumInteractiveMod, setScene, scene} from "./InteractiveAbstractClient_R12a.js";

const assets = "../../assets/";

setScene(Scene.buildFromName("InteractiveModelsAll_R12a"));
